...
BASE_URL = "https://location.am-all.net/alm/location?gm=109&ct=1000&at="
DETAIL_URL_BASE = "https://location.am-all.net/alm/shop?gm=109&astep=0&"
PREFECTURE_COUNT = 47
...
def build_row(tempo, prefecture, coordinate_cache, session):
    ...
    twitter = "https://twitter.com/intent/tweet?text=" + address + name
